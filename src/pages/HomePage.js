...
const HomePage = () => {
    ...
    const getAllTransection = async () => {
      try {
        ...
        const res = await axios.post(
          "https://backend-pettycash-project.vercel.app/transections/get-transection",
          {
            userid: user._id,
            frequency,
            selectedDate,
  ...
  const handleDelete = async (record) => {
    try {
      setLoading(true);
      await axios.post(
        "https://backend-pettycash-project.vercel.app/transections/delete-transection",
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (editable) {
        await axios.post(
          "https://backend-pettycash-project.vercel.app/transections/edit-transection",
          {
            payload: {
              ...values,
              userid: user._id,
        ...
        await axios.post(
          "https://backend-pettycash-project.vercel.app/transections/add-transection",
          {
            ...values,
            userid: user._id,
          }
